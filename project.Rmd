...
```
```{r Vizuelizacija zavisnosti atributa VendorID i tolls_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
vta <- data %>%
...
vendorIdImprovementSurcharge <- data %>%
    ...
    collect()
```
```{r Vizuelizacija zavisnosti atributa VendorID i improvement_surcharge, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
vis <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa VendorID i total_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
vta <- data %>%
...
### Analiza zavisnosti atributa VendorID i payed_with_card
```{r Analiza zavisnosti atributa VendorID i payed_with_card, message=FALSE, warning=FALSE, error=FALSE}
vendorIdPayedWithCard <- data %>%
    group_by(VendorID, payed_with_card) %>%
    summarise(count = n()) %>%
    collect()

kable(vendorIdPayedWithCard)
```
```{r Vizuelizacija zavisnosti atributa VendorID i payed_with_card, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
vpc <- data %>%
    select(VendorID, payed_with_card) %>%
    collect()

png("images/vendorIdPayedWithCard.png", width = 800, height = 1200)
mosaicplot(table(vpc), main = "Broj vožnji po VendorID-u i načinu plaćanja", xlab = "VendorID", ylab = "payed_with_card", color = c("red", "blue"))
dev.off()
```
![Broj vožnji po VendorID-u i načinu plaćanja](images/vendorIdPayedWithCard.png)
...
```
```{r Vizuelizacija zavisnosti atributa passenger_count i trip_distance, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
ptd <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa passenger_count i RatecodeID, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
pr <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa passenger_count i payment_type, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
ppt <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa passenger_count i fare_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
pfa <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa passenger_count i extra, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
pex <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa passenger_count i mta_tax, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
pmt <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa passenger_count i tip_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
pta <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa passenger_count i tolls_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
pta <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa passenger_count i improvement_surcharge, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
pis <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa passenger_count i total_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
pta <- data %>%
...
### Analiza zavisnosti atributa passenger_count i payed_with_card
```{r Analiza zavisnosti atributa passenger_count i payed_with_card, message=FALSE, warning=FALSE, error=FALSE}
passengerCountPayedWithCard <- data %>%
    group_by(passenger_count, payed_with_card) %>%
    summarise(count = n()) %>%
    collect()

kable(passengerCountPayedWithCard)
```
```{r Vizuelizacija zavisnosti atributa passenger_count i payed_with_card, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
ppc <- data %>%
    select(passenger_count, payed_with_card) %>%
    collect()

png("images/passengerCountPayedWithCard.png", width = 800, height = 1200)
mosaicplot(table(ppc), main = "Broj vožnji po broju putnika i načinu plaćanja", xlab = "Broj putnika", ylab = "payed_with_card", color = c("red", "blue"))
dev.off()
```
![Broj vožnji po broju putnika i načinu plaćanja](images/passengerCountPayedWithCard.png)
...
```
```{r Vizuelizacija zavisnosti atributa trip_distance i RatecodeID, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
tr <- data %>%
...
tripDistancePaymentType <- data %>%
    ...
    collect()
```
```{r Vizuelizacija zavisnosti atributa trip_distance i payment_type, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
tp <- data %>%
...
```{r Vizuelizacija zavisnosti atributa trip_distance i fare_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
tfa <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa trip_distance i extra, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
te <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa trip_distance i mta_tax, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
tmt <- data %>%
...
```{r Vizuelizacija zavisnosti atributa trip_distance i tip_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
tta <- data %>%
...
```{r Vizuelizacija zavisnosti atributa trip_distance i tolls_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
tta <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa trip_distance i improvement_surcharge, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
tis <- data %>%
...
```{r Vizuelizacija zavisnosti atributa trip_distance i total_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
tta <- data %>%
...
### Analiza zavisnosti atributa trip_distance i payed_with_card
```{r Analiza zavisnosti atributa trip_distance i payed_with_card, message=FALSE, warning=FALSE, error=FALSE}
tripDistancePayedWithCard <- data %>%
    group_by(payed_with_card) %>%
    summarise(min = min(trip_distance), max = max(trip_distance), avg = mean(trip_distance), median = median(trip_distance)) %>%
    collect()

kable(tripDistancePayedWithCard)
```
```{r Vizuelizacija zavisnosti atributa trip_distance i payed_with_card, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
tpc <- data %>%
    select(trip_distance, payed_with_card) %>%
    collect()

png("images/tripDistancePayedWithCard.png", width = 800, height = 1200)
boxplot(trip_distance ~ payed_with_card, data = tpc, main = "Dužina putovanja po načinu plaćanja", xlab = "Način plaćanja", ylab = "Dužina putovanja")
dev.off()
```
![Dužina putovanja po načinu plaćanja](images/tripDistancePayedWithCard.png)
...
```
```{r Vizuelizacija zavisnosti atributa RatecodeID i payment_type, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
rpt <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa RatecodeID i fare_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
rfa <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa RatecodeID i extra, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
rex <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa RatecodeID i mta_tax, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
rmt <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa RatecodeID i tip_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
rta <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa RatecodeID i tolls_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
rta <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa RatecodeID i improvement_surcharge, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
ris <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa RatecodeID i total_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
rta <- data %>%
...
### Analiza zavisnosti atributa RatecodeID i payed_with_card
```{r Analiza zavisnosti atributa RatecodeID i payed_with_card, message=FALSE, warning=FALSE, error=FALSE}
ratecodeIdPayedWithCard <- data %>%
    group_by(RatecodeID, payed_with_card) %>%
    summarise(count = n()) %>%
    collect()

kable(ratecodeIdPayedWithCard)
```
```{r Vizuelizacija zavisnosti atributa RatecodeID i payed_with_card, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
rpc <- data %>%
    select(RatecodeID, payed_with_card) %>%
    collect()

png("images/ratecodeIdPayedWithCard.png", width = 800, height = 1200)
mosaicplot(table(rpc), main = "Broj vožnji po RatecodeID-u i načinu plaćanja", xlab = "RatecodeID", ylab = "payed_with_card", color = c("red", "blue"))
dev.off()
```
![Broj vožnji po RatecodeID-u i načinu plaćanja](images/ratecodeIdPayedWithCard.png)
...
```
```{r Vizuelizacija zavisnosti atributa payment_type i fare_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
pfa <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa payment_type i extra, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
pex <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa payment_type i mta_tax, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
pmt <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa payment_type i tip_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
pta <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa payment_type i tolls_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
pta <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa payment_type i improvement_surcharge, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
pis <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa payment_type i total_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
pta <- data %>%
...
### Analiza zavisnosti atributa payment_type i payed_with_card
```{r Analiza zavisnosti atributa payment_type i payed_with_card, message=FALSE, warning=FALSE, error=FALSE}
paymentTypePayedWithCard <- data %>%
    group_by(payment_type, payed_with_card) %>%
    summarise(count = n()) %>%
    collect()

kable(paymentTypePayedWithCard)
```
```{r Vizuelizacija zavisnosti atributa payment_type i payed_with_card, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
ppc <- data %>%
    select(payment_type, payed_with_card) %>%
    collect()

png("images/paymentTypePayedWithCard.png", width = 800, height = 1200)
mosaicplot(table(ppc), main = "Broj vožnji po payment_type-u i načinu plaćanja", xlab = "payment_type", ylab = "payed_with_card", color = c("red", "blue"))
dev.off()
```
![Broj vožnji po payment_type-u i načinu plaćanja](images/paymentTypePayedWithCard.png)
...
```
```{r Vizuelizacija zavisnosti atributa fare_amount i extra, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
fae <- data %>%
    select(fare_amount, extra) %>%
    collect()

png("images/fareAmountExtra.png", width = 800, height = 1200)
mosaicplot(table(fae), main = "Broj vožnji po ceni vožnje i extra", xlab = "fare_amount", ylab = "extra", color = c("red", "blue"))
dev.off()
```
...
```
```{r Vizuelizacija zavisnosti atributa fare_amount i mta_tax, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
fmt <- data %>%
...
```{r Vizuelizacija zavisnosti atributa fare_amount i tip_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
fta <- data %>%
...
```{r Vizuelizacija zavisnosti atributa fare_amount i tolls_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
fta <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa fare_amount i improvement_surcharge, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
fis <- data %>%
...
```{r Vizuelizacija zavisnosti atributa fare_amount i total_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
fta <- data %>%
...
### Analiza zavisnosti atributa fare_amount i payed_with_card
```{r Analiza zavisnosti atributa fare_amount i payed_with_card, message=FALSE, warning=FALSE, error=FALSE}
fareAmountPayedWithCard <- data %>%
    group_by(payed_with_card) %>%
    summarise(min = min(fare_amount), max = max(fare_amount), avg = mean(fare_amount), median = median(fare_amount)) %>%
    collect()

kable(fareAmountPayedWithCard)
```
```{r Vizuelizacija zavisnosti atributa fare_amount i payed_with_card, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
fpc <- data %>%
    select(fare_amount, payed_with_card) %>%
    collect()

png("images/fareAmountPayedWithCard.png", width = 800, height = 1200)
mosaicplot(table(fpc), main = "Broj vožnji po ceni vožnje i načinu plaćanja", xlab = "fare_amount", ylab = "payed_with_card", color = c("red", "blue"))
dev.off()
```
![Broj vožnji po ceni vožnje i načinu plaćanja](images/fareAmountPayedWithCard.png)
...
kable(extraMtaTax)
```
```{r Vizuelizacija zavisnosti atributa extra i mta_tax, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
emt <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa extra i tip_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
eta <- data %>%
    select(extra, tip_amount) %>%
    collect()

png("images/extraTipAmount.png", width = 800, height = 1200)
mosaicplot(table(eta), main = "Broj vožnji po extra i tip_amount", xlab = "extra", ylab = "tip_amount", color = c("red", "blue", "green", "yellow", "purple", "orange"))
dev.off()
```
...
```
```{r Vizuelizacija zavisnosti atributa extra i tolls_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
eta <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa extra i improvement_surcharge, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
eis <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa extra i total_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
eta <- data %>%
...
### Analiza zavisnosti atributa extra i payed_with_card
```{r Analiza zavisnosti atributa extra i payed_with_card, message=FALSE, warning=FALSE, error=FALSE}
extraPayedWithCard <- data %>%
    group_by(extra, payed_with_card) %>%
    summarise(count = n()) %>%
    collect()

kable(extraPayedWithCard)
```
```{r Vizuelizacija zavisnosti atributa extra i payed_with_card, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
epc <- data %>%
    select(extra, payed_with_card) %>%
    collect()

png("images/extraPayedWithCard.png", width = 800, height = 1200)
mosaicplot(table(epc), main = "Broj vožnji po extra i načinu plaćanja", xlab = "extra", ylab = "payed_with_card", color = c("red", "blue"))
dev.off()
```
![Broj vožnji po extra i načinu plaćanja](images/extraPayedWithCard.png)
...
```
```{r Vizuelizacija zavisnosti atributa mta_tax i tip_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
mta <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa mta_tax i tolls_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
mta <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa mta_tax i improvement_surcharge, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
mis <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa mta_tax i total_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
mta <- data %>%
...
### Analiza zavisnosti atributa mta_tax i payed_with_card
```{r Analiza zavisnosti atributa mta_tax i payed_with_card, message=FALSE, warning=FALSE, error=FALSE}
mtaTaxPayedWithCard <- data %>%
    group_by(mta_tax, payed_with_card) %>%
    summarise(count = n()) %>%
    collect()

kable(mtaTaxPayedWithCard)
```
```{r Vizuelizacija zavisnosti atributa mta_tax i payed_with_card, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
mpc <- data %>%
    select(mta_tax, payed_with_card) %>%
    collect()

png("images/mtaTaxPayedWithCard.png", width = 800, height = 1200)
mosaicplot(table(mpc), main = "Broj vožnji po mta_tax-u i načinu plaćanja", xlab = "mta_tax", ylab = "payed_with_card", color = c("red", "blue"))
dev.off()
```
![Broj vožnji po mta_tax-u i načinu plaćanja](images/mtaTaxPayedWithCard.png)

### Analiza zavisnosti atributa tip_amount i tolls_amount
```{r Analiza zavisnosti atributa tip_amount i tolls_amount, message=FALSE, warning=FALSE, error=FALSE}
tipAmountTollsAmount <- data %>%
    group_by(tip_amount) %>%
    summarise(min = min(tolls_amount), max = max(tolls_amount), avg = mean(tolls_amount), median = median(tolls_amount)) %>%
    collect()

kable(tipAmountTollsAmount)
```
```{r Vizuelizacija zavisnosti atributa tip_amount i tolls_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
tta <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa tip_amount i improvement_surcharge, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
tis <- data %>%
...
```{r Vizuelizacija zavisnosti atributa tip_amount i total_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
tta <- data %>%
...
### Analiza zavisnosti atributa tip_amount i payed_with_card
```{r Analiza zavisnosti atributa tip_amount i payed_with_card, message=FALSE, warning=FALSE, error=FALSE}
tipAmountPayedWithCard <- data %>%
    group_by(payed_with_card) %>%
    summarise(min = min(tip_amount), max = max(tip_amount), avg = mean(tip_amount), median = median(tip_amount)) %>%
    collect()

kable(tipAmountPayedWithCard)
```
```{r Vizuelizacija zavisnosti atributa tip_amount i payed_with_card, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
tpc <- data %>%
    select(tip_amount, payed_with_card) %>%
    collect()

png("images/tipAmountPayedWithCard.png", width = 800, height = 1200)
boxplot(tip_amount ~ payed_with_card, data = tpc, main = "Napojnica po načinu plaćanja", xlab = "Način plaćanja", ylab = "Napojnica")
dev.off()
```
![Napojnica po načinu plaćanja](images/tipAmountPayedWithCard.png)
...
```
```{r Vizuelizacija zavisnosti atributa tolls_amount i improvement_surcharge, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
tis <- data %>%
...
```{r Vizuelizacija zavisnosti atributa tolls_amount i total_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
tta <- data %>%
...
### Analiza zavisnosti atributa tolls_amount i payed_with_card
```{r Analiza zavisnosti atributa tolls_amount i payed_with_card, message=FALSE, warning=FALSE, error=FALSE}
tollsAmountPayedWithCard <- data %>%
    group_by(payed_with_card) %>%
    summarise(min = min(tolls_amount), max = max(tolls_amount), avg = mean(tolls_amount), median = median(tolls_amount)) %>%
    collect()

kable(tollsAmountPayedWithCard)
```
```{r Vizuelizacija zavisnosti atributa tolls_amount i payed_with_card, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
tpc <- data %>%
    select(tolls_amount, payed_with_card) %>%
    collect()

png("images/tollsAmountPayedWithCard.png", width = 800, height = 1200)
boxplot(tolls_amount ~ payed_with_card, data = tpc, main = "Troškovi putarine po načinu plaćanja", xlab = "Način plaćanja", ylab = "Troškovi putarine")
dev.off()
```
![Troškovi putarine po načinu plaćanja](images/tollsAmountPayedWithCard.png)

### Analiza zavisnosti atributa improvement_surcharge i total_amount
```{r Vizuelizacija zavisnosti atributa improvement_surcharge i total_amount, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
its <- data %>%
...
### Analiza zavisnosti atributa improvement_surcharge i payed_with_card
```{r Analiza zavisnosti atributa improvement_surcharge i payed_with_card, message=FALSE, warning=FALSE, error=FALSE}
improvementSurchargePayedWithCard <- data %>%
    group_by(payed_with_card, improvement_surcharge) %>%
    summarise(count = n()) %>%
    collect()

kable(improvementSurchargePayedWithCard)
```
```{r Vizuelizacija zavisnosti atributa improvement_surcharge i payed_with_card, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
ipc <- data %>%
    select(improvement_surcharge, payed_with_card) %>%
    collect()

png("images/improvementSurchargePayedWithCard.png", width = 800, height = 1200)
mosaicplot(table(ipc), main = "Broj vožnji po improvement surcharge-u i načinu plaćanja", xlab = "improvement surcharge", ylab = "payed_with_card", color = c("red", "blue"))
dev.off()
```
![Broj vožnji po improvement surcharge-u i načinu plaćanja](images/improvementSurchargePayedWithCard.png)

### Analiza zavisnosti atributa total_amount i payed_with_card
```{r Vizuelizacija zavisnosti atributa total_amount i payed_with_card, include=FALSE, message=FALSE, warning=FALSE, error=FALSE}
tpc <- data %>%
    select(total_amount, payed_with_card) %>%
    collect()

png("images/totalAmountPayedWithCard.png", width = 800, height = 1200)
boxplot(total_amount ~ payed_with_card, data = tpc, main = "Ukupna cena po načinu plaćanja", xlab = "Način plaćanja", ylab = "Ukupna cena")
dev.off()
```
![Ukupna cena po načinu plaćanja](images/totalAmountPayedWithCard.png)
...
models[[2]] <- tip_amount ~ VendorID + RatecodeID + PULocationID + DOLocationID
