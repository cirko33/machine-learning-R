...
```
```{r Vizuelizacija atributa payed_with_card, include=FALSE, eval=FALSE, message=FALSE, warning=FALSE, error=FALSE}
...
```
```{r Vizuelizacija zavisnosti atributa VendorID i payed_with_card, include=FALSE, eval=FALSE, message=FALSE, warning=FALSE, error=FALSE}
vpc <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa passenger_count i payed_with_card, include=FALSE, eval=FALSE, message=FALSE, warning=FALSE, error=FALSE}
ppc <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa trip_distance i payed_with_card, include=FALSE, eval=FALSE, message=FALSE, warning=FALSE, error=FALSE}
tpc <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa RatecodeID i payed_with_card, include=FALSE, eval=FALSE, message=FALSE, warning=FALSE, error=FALSE}
rpc <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa payment_type i payed_with_card, include=FALSE, eval=FALSE, message=FALSE, warning=FALSE, error=FALSE}
ppc <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa fare_amount i payed_with_card, include=FALSE, eval=FALSE, message=FALSE, warning=FALSE, error=FALSE}
fpc <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa extra i payed_with_card, include=FALSE, eval=FALSE, message=FALSE, warning=FALSE, error=FALSE}
epc <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa mta_tax i payed_with_card, include=FALSE, eval=FALSE, message=FALSE, warning=FALSE, error=FALSE}
mpc <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa tip_amount i payed_with_card, include=FALSE, eval=FALSE, message=FALSE, warning=FALSE, error=FALSE}
tpc <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa tolls_amount i payed_with_card, include=FALSE, eval=FALSE, message=FALSE, warning=FALSE, error=FALSE}
tpc <- data %>%
...
```
```{r Vizuelizacija zavisnosti atributa improvement_surcharge i payed_with_card, include=FALSE, eval=FALSE, message=FALSE, warning=FALSE, error=FALSE}
ipc <- data %>%
...
```{r Vizuelizacija zavisnosti atributa total_amount i payed_with_card, include=FALSE, eval=FALSE, message=FALSE, warning=FALSE, error=FALSE}
tpc <- data %>%
